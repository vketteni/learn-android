...
object LearnDestinations {
    ...
    const val CARD_ADD_EDIT_ROUTE = "$CARD_ADD_EDIT_SCREEN/{$DECK_ID_ARG}?$CARD_ID_ARG={$CARD_ID_ARG}"
}
...
//            popUpTo(navController.graph.findStartDestination().id)
    ...
    fun navigateToDeckAddEdit(deckId: String?) {
        navController.navigate(
            DECK_ADD_EDIT_SCREEN.let {
    ...
    fun navigateToCardAddEdit(deckId: String, cardId: String?) {
        navController.navigate(
            "$CARD_ADD_EDIT_SCREEN/$deckId".let {
